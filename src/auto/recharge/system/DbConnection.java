...
public class DbConnection {
    ...
    private static void tableCreate() {
        ...
        tableCreateSqlQueryList.add("CREATE TABLE IF NOT EXISTS product_sell_table (id integer PRIMARY KEY,	id int(255),sell_type varchar(255),bar_code varchar(255),group varchar(255),p_name varchar(255),qty varchar(255),price varchar(255),sub_total varchar(255));");
        tableCreateSqlQueryList.add("CREATE TABLE IF NOT EXISTS recharge_admin (id integer PRIMARY KEY,	mobile_no varchar(255),amount varchar(255),date_time varchar(255),status varchar(255),trx_id varchar(255),type varchar(255),from_sp varchar(255),current_balance varchar(255));");
        tableCreateSqlQueryList.add("CREATE TABLE IF NOT EXISTS recharge_offers (id integer PRIMARY KEY,	offer_name varchar(255),recharge_amt varchar(255),validity varchar(255),description varchar(255),sim_name varchar(255));");

        tableCreateSqlQueryList.add("CREATE TABLE IF NOT EXISTS sell_table (id integer PRIMARY KEY,	invoice varchar(255),customerId varchar(255),date varchar(255),due_date varchar(255),fName varchar(255),address varchar(255),note varchar(255),mobileNo varchar(255),totalItems varchar(255),return varchar(255),total_amount varchar(255),discount varchar(255),payable varchar(255),paid varchar(255),due_payment varchar(255),due varchar(255),payment_way varchar(255),sellType varchar(255),bar_code varchar(255),group varchar(255),p_name varchar(255),qty varchar(255),price varchar(255),sub_total varchar(255),warranty varchar(255));");

        tableCreateSqlQueryList.add("CREATE TABLE IF NOT EXISTS sms (id integer PRIMARY KEY,	phoneNo varchar(255),time_date varchar(255),sim_name varchar(255),mgs varchar(255));");
        tableCreateSqlQueryList.add("CREATE TABLE IF NOT EXISTS warranty_table (id integer PRIMARY KEY,	invoice varchar(255),customar_id varchar(255),date varchar(255),d_date varchar(255),problem varchar(255),f_name varchar(255),address varchar(255),mobole_no varchar(255),ref_name varchar(255),brand varchar(255),status varchar(255),bill varchar(255),warranty varchar(255),paid varchar(255),discount varchar(255),due varchar(255));");
        try {
            Class.forName("org.sqlite.JDBC");
            Connection conn = DriverManager.getConnection("jdbc:sqlite:Users.sqlite");
