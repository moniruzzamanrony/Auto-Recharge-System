...
public class DbConnection {
    ...
    private static void tableCreate() {
        ...
        tableCreateSqlQueryList.add("CREATE TABLE IF NOT EXISTS sell_table (RecNo integer PRIMARY KEY,	invoice varchar(255),customerId varchar(255),date varchar(255),due_date varchar(255),fName varchar(255),address varchar(255),note varchar(255),mobileNo varchar(255),totalItems varchar(255),return varchar(255),total_amount varchar(255),discount varchar(255),payable varchar(255),paid varchar(255),due_payment varchar(255),due varchar(255),payment_way varchar(255),sellType varchar(255),bar_code varchar(255),group_products varchar(255),p_name varchar(255),qty varchar(255),price varchar(255),sub_total varchar(255),warranty varchar(255));");
